<div class=" w-full dark:bg-slate-800 gap-6 flex items-center justify-center">
  <div
    class="w-1/2 bg-gray-100 dark:bg-gray-700 relative shadow-xl overflow-hidden hover:shadow-2xl group rounded-xl p-5 transition-all duration-500 transform">
    <div class="flex items-center gap-4">
      <img src="https://www.majidkavian.com/wp-content/uploads/2019/09/Industrial-Photography-Charlotte-Commercial-Photographer-Taylor-Clark-Johnson-2-2.jpg"
    ...
    />
      <div class="w-fit transition-all transform duration-500">
        ...
        <p class="text-gray-400">توضیح کوتاه محصول</p>
        <a
