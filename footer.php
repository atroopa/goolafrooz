  ...
  <div class="bg-cover bg-center w-full h-full " style="background-image: url(https://golafrooz.com/wp-content/uploads/2024/04/R-1-scaled.jpeg)">
    ...
    <div class="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-white/10 lg:justify-between">
      <div class="me-12 hidden lg:block backdrop-blur-2xl bg-white/30  p-5 rounded-2xl">
        <span>پل ارتباطی با شرگت گلخانه سازی گل افروز</span>
      </div>
      <!-- Social network icons container -->
      <div class="flex justify-center backdrop-blur-2xl bg-white/30  p-5 rounded-2xl">
        <a href="https://api.whatsapp.com/send?phone=+989147281416" class="me-6 [&>svg]:h-4 [&>svg]:w-4">
        ...
        <a href="https://t.me/golafroozcom" class="me-6 [&>svg]:h-4 [&>svg]:w-4 ">
        ...
        <a href="https://rubika.ir/golafroozcom" class="me-6 [&>svg]:h-4 [&>svg]:w-4">
          <img class="h-4 w-4" src="https://golafrooz.com/wp-content/uploads/2024/04/rubika.png" alt="rubika logo golafrooz">
        </a>
        <a href="https://www.instagram.com/golafrooz.com123/" class="me-6 [&>svg]:h-4 [&>svg]:w-4">
      ...
      <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <p class="mb-4 flex text-right items-center justify-center md:justify-start">
            ...
            البرز - کرج - عظیمیه بالاتر از پل آزادگان - ساختمان قائم - طبقه 7 - واحد 708
